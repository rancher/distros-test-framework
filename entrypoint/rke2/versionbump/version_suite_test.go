...
import (
	...
	"github.com/rancher/distros-test-framework/core/service/template"
...
func TestMain(m *testing.M) {
	flag.StringVar(&template.TestMapTemplate.Cmd, "cmd", "", "Comma separated list of"+
		""+
		" commands to execute")
	...
	flag.StringVar(&template.TestMapTemplate.ExpectedValueUpgrade, "expectedValueUpgrade", "",
		"Expected value of the command ran on Node after upgrading")
	flag.Var(&customflag.ServiceFlag.InstallUpgrade, "installVersionOrCommit",
		"Install upgrade customflag")
	flag.StringVar(&customflag.ServiceFlag.InstallType.Channel, "channel", "",
		"channel to use on install or upgrade")
	flag.Var(&customflag.TestCaseNameFlag, "testCase", "Comma separated list of test case "+
		"names to run")
	flag.BoolVar(&customflag.ServiceFlag.TestConfig.DeployWorkload, "deployWorkload", false,
		"Deploy workload customflag")
