...
func TestMain(m *testing.M) {
	...
	flag.StringVar(&customflag.TestMap.ExpectedChartsValue, "expectedChartsValue", "", "Comma separated list of expected charts values for commands")
	flag.StringVar(&customflag.TestMap.ExpectedChartsValueUpgrade, "expectedChartsValueUpgrade", "", "Expected charts value of the command ran after upgrading")
