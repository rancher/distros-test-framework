...
func TestMain(m *testing.M) {
	flag.StringVar(&template.TestMapTemplate.Cmd, "cmd", "", "Comma separated list "+
	...
	flag.Var(&customflag.TestCaseNameFlag, "testCase", "Comma separated list of test "+
		"case names to run")
	...
	flag.BoolVar(&customflag.ServiceFlag.TestConfig.DeployWorkload, "deployWorkload", false,
		"Deploy workload customflag for tests passed in")
	flag.Var(&customflag.ServiceFlag.ClusterConfig.Destroy, "destroy",
		"Destroy cluster after test")
	flag.Var(&customflag.ServiceFlag.ClusterConfig.Arch, "arch",
		"Architecture type")
