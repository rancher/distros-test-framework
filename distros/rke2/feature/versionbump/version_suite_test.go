...
func TestMain(m *testing.M) {
	...
	flag.StringVar(&template.TestMapTemplate.ExpectedValueUpgrade, "expectedValueUpgrade", "", "Expected value of the command ran on Node after upgrading")
	flag.Var(&cmd.ServiceFlag.InstallUpgrade, "installVersionOrCommit", "Install upgrade cmd")
	...
	flag.BoolVar(&cmd.ServiceFlag.TestConfig.DeployWorkload, "deployWorkload", false, "Deploy workload cmd")
