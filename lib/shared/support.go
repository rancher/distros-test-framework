...
func ManageWorkload(action, workload string) (string, error) {
	...
	resourceDir := BasePath() + "/resource/workloads/"
...
// RestartServiceOnNode restarts given service on each node given by external IP.
func RestartServiceOnNode(service, ip string) (string, error) {
