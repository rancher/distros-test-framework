...
func DestroyInfrastructure(product, module string) (string, error) {
	// This should be moved to infrastructure package
	return "", fmt.Errorf("not implemented - should be in infrastructure package")
}

func setTerraformOptionsLegacy(product, module string) (*terraform.Options, string, error) {
	// This should be moved to infrastructure package
	return nil, "", fmt.Errorf("not implemented - should be in infrastructure package")
}

func addSplitRole(t *testing.T, splitRoles *splitRolesConfig, varDir string, numServers int) (int, error) {
	// This should be moved to infrastructure package
	return 0, fmt.Errorf("not implemented - should be in infrastructure package")
}

func loadTFconfig(t *testing.T, c *Cluster, product, module, varDir string, terraformOptions *terraform.Options) (*Cluster, error) {
	// This should be moved to infrastructure package
	return nil, fmt.Errorf("not implemented - should be in infrastructure package")
}
