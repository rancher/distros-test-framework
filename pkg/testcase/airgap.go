...
func TestBuildPrivateCluster(cluster *factory.Cluster) {
...
func TestAirgapPrivateRegistry(cluster *factory.Cluster, flags *customflag.FlagConfig) {
	// Setting up bastion
...
func SetupBastion(cluster *factory.Cluster, flags *customflag.FlagConfig) {
...
func DockerActions(cluster *factory.Cluster, flags *customflag.FlagConfig, hostname, image string) {
	// pull image
